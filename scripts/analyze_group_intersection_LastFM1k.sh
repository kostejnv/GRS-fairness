...
do
    ...
    do
        python analyze_group_embedding_intersection.py --dataset LastFM1k --sae_run_id "$sae_run_id" --group_type "$group_type" --group_size 3 --user_set train --note "$note"  --topk_inference
    done
done