...
class ResultsAggregationStrategy(ABC):
    name: str
...
class BaselinesAggregator(ResultsAggregationStrategy):
...
class GFARAggregator(ResultsAggregationStrategy):
    def __init__(self):
        super().__init__("GFAR")
...
class EPFuzzDAAggregator(ResultsAggregationStrategy):
